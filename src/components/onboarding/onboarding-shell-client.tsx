...
import { pendingInvitesMenuButtonLabel } from "@/components/dashboard/dashboard-nav";
import { SignOutButton } from "@/components/sign-out-button";
import type { Athlete } from "@/lib/types";

type OnboardingShellClientProps = {
  userEmail: string;
  isAdmin?: boolean;
  athletes?: Athlete[];
...
export function OnboardingShellClient({
  userEmail,
  isAdmin = false,
  athletes = [],
